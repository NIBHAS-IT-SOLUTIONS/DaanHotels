...
function Contact() {
  ...
  return (
    ...
    <div>
      <Helmet>
  <title>Contact Daan Group | Hotels Near Kottayam Railway Station</title>
  <meta name="description" content="Get in touch with Daan Group. Reach our hotels near the Kottayam railway station. We're here to assist you with your bookings and queries across Kerala." />
</Helmet>
        ...
        <div className="contact-page">
            ...
            <section className="d-flex flex-column justify-content-center align-items-center contact-hero text-center"
       style={{
                      height: '650px',
